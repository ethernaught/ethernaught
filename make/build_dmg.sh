...
cp ../res/icons/app/icon_128x128.png     ../build/icon.iconset/icon_128x128.png
cp ../res/icons/app/icon_256x256.png     ../build/icon.iconset/icon_128x128@2x.png
cp ../res/icons/app/icon_512x512.png     ../build/icon.iconset/icon_256x256@2x.png
#cp ../res/icons/app/icon_1024x1024.png   ../build/icon.iconset/icon_512x512@2x.png

iconutil -c icns ../build/icon.iconset

mkdir -p "$DMG_DIR/$APP_NAME.app/Contents/Resources"
mv ../build/icon.icns "$DMG_DIR/$APP_NAME.app/Contents/Resources/"
